...
uses
  Classes, SysUtils, LCLIntf, LCLType, LMessages, Graphics;
    ...
    mdColor: begin
      for y := 0 to 191 do begin
        ...
        repeat
          vl := mappa^[YPos[y] + bx];
          v := mappa^[YPos[y] + bx + 1];
          if (vl and 128) <> 0 then begin
            fl1 := 4;
          end
          else begin
            fl1 := 0;
          end;
          if (v and 128) <> 0 then begin
            fl2 := 4;
          end
          else begin
            fl2 := 0;
